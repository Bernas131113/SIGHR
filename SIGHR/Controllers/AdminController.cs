...
{
    // A política "AdminAccessUI" garante que apenas usuários com o role "Admin" acessem,
    // independentemente do esquema de login que usaram.
    ...
    public class AdminController : Controller
    {
        ...
        // GET: /Admin/Index (Gestão de todos os registos de ponto)
